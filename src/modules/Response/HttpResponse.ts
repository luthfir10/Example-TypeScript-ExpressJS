...
class HttpResponse {
     ...
     * @returns
     */
    private static baseResponse<TData>(dataResponse: DataResponseEntity<TData>): DtoHttpResponse<TData> {
     ...
     * @returns
     */
    public static get<TData>(dataResponse: DataResponseEntity<TData>, options?: ReqOptions): DtoHttpResponse<TData> {
     ...
     * @returns
     */
    public static created<TData>(dataResponse: DataResponseEntity<TData>, options?: ReqOptions): DtoHttpResponse<TData> {
        const i18nOpt: string | TOptions = { lng: options?.lang };
     ...
     * @returns
     */
    public static updated<TData>(dataResponse: DataResponseEntity<TData>, options?: ReqOptions): DtoHttpResponse<TData> {
        const i18nOpt: string | TOptions = { lng: options?.lang };
     ...
     * @returns
     */
    public static deleted<TData>(dataResponse: DataResponseEntity<TData>, options?: ReqOptions): DtoHttpResponse<TData> {
        const i18nOpt: string | TOptions = { lng: options?.lang };
