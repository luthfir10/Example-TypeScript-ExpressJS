import { logErrServer } from '../helpers/Formatter';
import { NextFunction, Request, Response } from 'express';
import { ValidationError } from 'yup';

async function ExpressErrorYup(err: any, req: Request, res: Response, next: NextFunction): Promise<Response<any, Record<string, any>> | undefined> {
