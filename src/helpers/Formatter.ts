...
const invalidValues = [null, undefined, '', false, 0, 'false', '0', 'null', 'undefined'];
...
export { arrayFormatter, validateEmpty, validateBoolean, validateUUID, logServer, logErrServer };
